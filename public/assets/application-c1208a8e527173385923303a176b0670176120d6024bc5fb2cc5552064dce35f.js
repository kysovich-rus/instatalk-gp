...
(function() {
  ...
  jQuery(document).on('turbolinks:load', function() {
    var ScrollBottom, createRoomChannel, messages;
    messages = $('#messages');
    ...
    return ScrollBottom = function(speed) {
...
(function() {
  App.status = App.cable.subscriptions.create("StatusChannel", {
    ...
    disconnected: function() {
      return console.log('StatusChannel disconnected');
    },
    received: function(data) {
      var users;
      console.log(data["users"]);
      users = data["users"].map(function(i) {
        return "<div><i class='bi bi-person-fill'></i>" + i + "</div>";
      });
      return $('#users_online').html(users.join(''));
    }
  });
